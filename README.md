...
Computer Science student passionate about backend development, distributed systems, and building scalable applications using Java and Spring Boot.
...
An AI-powered email reply generator built with Spring Boot and Spring AI to generate context-aware email responses using Google's Gemini API.
